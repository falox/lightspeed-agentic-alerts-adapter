...
Defines how the adapter avoids creating duplicate Proposals for the same alert, including initial delay filtering, active Proposal detection, cooldown windows, deterministic naming, and stateless operation.
