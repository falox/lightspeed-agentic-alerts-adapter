...
Defines how the adapter creates Proposal custom resources from firing alerts, including namespace placement, request composition, workflow configuration, metadata labeling, and lifecycle boundaries.
